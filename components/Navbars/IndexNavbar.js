...
export default function Navbar(props) {
  ...
  return (
    <>
      <nav className="w-full absolute flex flex-wrap items-center justify-between px-2 py-3 navbar-expand-lg border-t-0 border-x-0 border-b border-b-black bg-transparent">
